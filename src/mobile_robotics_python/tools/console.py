...
class Console:
    ...
    @staticmethod
    def get_version(pkg_name="mobile_robotics_python"):
        """Returns pkg_name version number

        Parameters
        ----------
        pkg_name : str
            Name of the python package, by default 'mobile_robotics_python'
    ...
    @staticmethod
    def set_logging_file(folder_path: str) -> None:
        global logger
        ...
        if logger is not None:
            logger.info("mobile_robotics_python version: " + str(Console.get_version()))
